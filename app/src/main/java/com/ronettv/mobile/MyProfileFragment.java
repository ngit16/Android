...
public class MyProfileFragment extends Fragment implements
    ...
    public static String TAG = com.ronettv.mobile.MyProfileFragment.class.getName();
    ...
    public void ChangePwd_onClick(View v) {
        ...
        com.ronettv.mobile.ChangePwdDialogFragment newFragment = new ChangePwdDialogFragment();
