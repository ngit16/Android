...
public class
    ...
    public void PullnInsertServices(SQLiteDatabase db) {
        ...
        if (serviceList != null && serviceList.size() > 0) {
            ...
            Date date = new Date();
            String formattedDate = com.ronettv.mobile.MyApplication.df.format(date);
            editor.putString(
    ...
    public PayPalConfiguration getPaypalConfig() {
        config = new PayPalConfiguration()
                ...
                .merchantName("ronettv Mobile Application")
                .merchantPrivacyPolicyUri(
                        Uri.parse("https://www.ronettv.com/privacy"))
                .merchantUserAgreementUri(
                        Uri.parse("https://www.ronettv.com/legal"));
