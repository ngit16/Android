        ...
        protected ResponseObj doInBackground(Void... params) {
            ...
            if (Utilities.isNetworkAvailable(getApplicationContext())) {
                ...
                for (Subscriptiondatum data : mSubscription) {
                    ...
                    System.out.println("subscriptionperiod:" + value1);
                    if (value.equalsIgnoreCase(value1)) {
                        subId = data.getId();
                        //System.out.println("subId:" + subId + ",subscriptionperiod:" + value1+ ", Duration:" + value);
                    }
                }
                ...
                map.put("locale", "en");
                //map.put("contractPeriod", mPayterms.get(selPaytermId).getDuration()+"");
        ...
        protected void onPostExecute(ResponseObj resObj) {
            ...
            if (resObj.getStatusCode() == 200) {
                ...
                intent.putExtra(DoBGTasksService.TASK_ID,
                        MyApplication.DoBGTasks.UPDATESERVICES_CONFIGS.ordinal());
                startService(intent);
