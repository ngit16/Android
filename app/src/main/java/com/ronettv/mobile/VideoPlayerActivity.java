...
public class VideoPlayerActivity extends Activity implements
            ...
            if (msg.what == 1) {
                if (mProgressDialog != null && !mProgressDialog.isShowing()) {
                    mProgressDialog = new ProgressDialog(
                            com.ronettv.mobile.VideoPlayerActivity.this,
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (videoType.equalsIgnoreCase("LIVETV")) {
            ...
            com.ronettv.mobile.VideoControllerView.sDefaultTimeout = 3000;
            mChannelId = getIntent().getIntExtra("CHANNELID", 0);
        } else if (videoType.equalsIgnoreCase("VOD")) {
            isLiveController = false;
            com.ronettv.mobile.VideoControllerView.sDefaultTimeout = 3000;
        }
        controller = new com.ronettv.mobile.VideoControllerView(this, (!isLiveController));
        try {
            player.setDisplay(holder);
            ...
            mProgressDialog = new ProgressDialog(com.ronettv.mobile.VideoPlayerActivity.this,
                    ProgressDialog.THEME_HOLO_DARK);
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
        ...
        if (what == MediaPlayer.MEDIA_ERROR_UNKNOWN && extra == -2147483648) {
            ...
            controller.mHandler
                    .removeMessages(com.ronettv.mobile.VideoControllerView.SHOW_PROGRESS);
            controller.mHandler.removeMessages(com.ronettv.mobile.VideoControllerView.FADE_OUT);
