...
import com.ronettv.paypal.PaypalHelper.UpdatePaymentTaskListener;
...
public class VodMovieDetailsActivity extends Activity implements
        ...
        public void failure(RetrofitError retrofitError) {
            if (!mIsReqCanceled) {
                ...
                if (retrofitError.isNetworkError()) {
                    Toast.makeText(
                            com.ronettv.mobile.VodMovieDetailsActivity.this,
        ...
        public void success(MediaDetailsResDatum data, Response response) {
            if (!mIsReqCanceled) {
                ...
                if (data != null) {
                    ...
                    Toast.makeText(com.ronettv.mobile.VodMovieDetailsActivity.this,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((!(mediaId.equalsIgnoreCase("")) || mediaId != null)
            ...
            Intent updateDataIntent = new Intent(com.ronettv.mobile.VodMovieDetailsActivity.this,
                    DoBGTasksService.class);
            updateDataIntent.putExtra(DoBGTasksService.TASK_ID,
                    DoBGTasks.UPDATECLIENT_CONFIGS.ordinal());
            com.ronettv.mobile.VodMovieDetailsActivity.this.startService(updateDataIntent);
            UpdateDetails();
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_home:
                startActivity(new Intent(com.ronettv.mobile.VodMovieDetailsActivity.this,
                        MainActivity.class)
    ...
    public void btnOnClick(View v) {
        ...
        if ((mVodPrice != 0 && (-balance < mVodPrice)) || balance > 0) {
            ...
            AlertDialog dialog = new AlertDialog.Builder(
                    com.ronettv.mobile.VodMovieDetailsActivity.this, AlertDialog.THEME_HOLO_LIGHT)
                    .create();
    ...
    public void UpdateDetails() {
        ...
        mProgressDialog = new ProgressDialog(com.ronettv.mobile.VodMovieDetailsActivity.this,
            ...
            if (info == null) {
                ...
                if (info == null) {
                    AlertDialog mConfirmDialog = ((MyApplication) getApplicationContext())
                            .getConfirmDialog(com.ronettv.mobile.VodMovieDetailsActivity.this);
                    mConfirmDialog
    ...
    public String getTag() {
        ...
        return com.ronettv.mobile.VodMovieDetailsActivity.this.getClass().getName();
    }
    ...
    private class doBackGround extends AsyncTask<String, Void, ResponseObj> {
        ...
        protected ResponseObj doInBackground(String... params) {
            ...
            if (Utilities.isNetworkAvailable(com.ronettv.mobile.VodMovieDetailsActivity.this
                ...
                resObj = Utilities.callExternalApiPostMethod(
                        com.ronettv.mobile.VodMovieDetailsActivity.this.getApplicationContext(),
                        map);
                return resObj;
            } else {
