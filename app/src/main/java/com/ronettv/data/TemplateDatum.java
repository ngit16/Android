...
public class TemplateDatum {
    ...
    private List<com.ronettv.data.OfficeOptionDatum> officeOptions = new ArrayList<com.ronettv.data.OfficeOptionDatum>();
    ...
    public List<com.ronettv.data.OfficeOptionDatum> getOfficeOptions() {
