...
public class PlanDatum {
    ...
    private com.ronettv.data.PlanstatusDatum planstatus;
    ...
    public com.ronettv.data.PlanstatusDatum getPlanstatus() {
        return planstatus;
    }

    public void setPlanstatus(com.ronettv.data.PlanstatusDatum planstatus) {
