...
public class ChannelGridViewAdapter extends BaseAdapter {
    private List<com.ronettv.data.ServiceDatum> channelList;
    private LayoutInflater inflater;
    private Context mContext;

    public ChannelGridViewAdapter(List<com.ronettv.data.ServiceDatum> channelList,
                                  Activity context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.ronettv.data.ServiceDatum data = channelList.get(position);
