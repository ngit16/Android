...
public class ServiceProvider extends ContentProvider {
    ...
    com.ronettv.database.DBHelper dbHelper;
    SQLiteDatabase db;
    ...
    public boolean onCreate() {
        ...
        this.dbHelper = new com.ronettv.database.DBHelper(getContext());
        return false;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (mUriMatcher.match(uri)) {
            case SERVICES:
                ...
                cursor = db.query(com.ronettv.database.DBHelper.TABLE_SERVICES, projection, selection,
            ...
            case SERVICE_CATEGORIES:
                ...
                cursor = db.query(com.ronettv.database.DBHelper.TABLE_SERVICE_CATEGORIES, projection,
            ...
            case SERVICE_SUB_CATEGORIES:
                ...
                cursor = db.query(com.ronettv.database.DBHelper.TABLE_SERVICE_SUB_CATEGORIES,
                        projection, selection, selectionArgs, null, null,
                        sortOrder1);
                if (cursor.getCount() == -1) {
                    doRefreshData(db);
                    cursor = db.query(com.ronettv.database.DBHelper.TABLE_SERVICE_SUB_CATEGORIES, projection,
                            selection, selectionArgs, null, null, sortOrder1);
                }
                return cursor;
            default:
